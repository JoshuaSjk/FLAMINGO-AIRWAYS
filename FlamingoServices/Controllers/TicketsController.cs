...
namespace FlamingoServices.Controllers
{
    ...
    public class TicketsController : ControllerBase
    {
        ...
        public TicketsController(FlamingoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Ticket>> PostTicket(Ticket ticket)
        {
            ...
            {
                if (TicketExists(ticket.Pnrnumber))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetTicket", new { id = ticket.Pnrnumber }, ticket);
        }
        ...
        {
            return _context.Tickets.Any(e => e.Pnrnumber == id);
        }
    }
}
